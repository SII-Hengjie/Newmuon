...
def parse():
    ...
    parser.add_argument("--enable_scheduler", type=bool, default=True)
    ...
    parser.add_argument("--orth-initialization", action="store_true")
    
    parser.add_argument("--rf", type=float, default=0.015)
    parser.add_argument("--prob", type=float, default=0.1)
    parser.add_argument("--dion_iters", type=int, default=1)
    
    parser.add_argument("--tp-simulate", action="store_true")
    parser.add_argument("--tp-parts", type=int, default=4)
