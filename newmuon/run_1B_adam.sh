...
nohup python -m torch.distributed.launch --nproc_per_node $NPROC --master-port $PORT dp_main_getdata.py > /inspire/hdd/project/yunweiyuhuifu/p-shangli/Metis-quantization-muon/nohupout/$TAG.log \
    ...
    --load-from /inspire/hdd/project/yunweiyuhuifu/p-shangli/Metis-quantization-muon/checkpoint/1B_bf16_adam_logckpt/0_10000.pth
